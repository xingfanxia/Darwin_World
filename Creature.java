...
public class Creature extends BaseCreature {
  ...
  public void setSpecies(BaseSpecies spec) {
    species = spec;
  }
  ...
  public void takeOneTurn() {
    ...
    if (facePoint != null && !world.worldGraph().getEdge(point, facePoint)) facePoint = null;
    ...
    switch (op) {
        ...
        if (facePoint != null) {
          ...
          if (infected != null && !infected.getSpecies().getName().equals(species.getName())) {
            ...
            world
                ...
                .updateSquare(
                    infected.point,
                    infected.getSpecies().getName().substring(0, 1),
                    infected.dir,
                    infected.getSpecies().getColor());
          }
        }
        curK++;
        break;
      ...
      case IFEMPTY:
        if (facePoint != null && world.worldGraph().getCreature(facePoint) == null) curK = arg;
        else curK++;
        takeOneTurn();
        break;

      case IFWALL:
        if (facePoint == null) curK = arg;
        else curK++;
        takeOneTurn();
        break;
      ...
      case IFSAME:
        if (facePoint != null) {
          ...
          if (facing != null && facing.getSpecies().getName().equals(species.getName())) curK = arg;
          else curK++;
        } else curK++;
        takeOneTurn();
        break;
      ...
      case IFRANDOM:
        if (world.rgen.nextDouble() < .5) curK = arg;
        else curK++;
        takeOneTurn();
        break;
