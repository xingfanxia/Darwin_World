/**
 * *********************************************************************** Original code obtained
 * from cs.princeton.edu, COS126. Modified by Sherri Goings for Data Structures (CS201) at Carleton
 * College. Last modified Fall 2011.
 *
 * <p>Drawing library with many functions that provide a basic capability for creating drawings with
 * your programs. It uses a simple graphics model that allows you to create drawings consisting of
 * points, lines, and curves in a window on your computer and to save the drawings to a file.
 * ***********************************************************************
 */
...
public final class Draw implements MouseListener, KeyListener {
  ...
  public static final Color[] colorList = {
    BLACK, BLUE, GREEN, MAGENTA, ORANGE, PINK, RED, LIGHT_GRAY, YELLOW, CYAN, DARK_GRAY, GRAY, WHITE
  };
  ...
  /**
   * Set the pen color to the given color. The available pen colors are BLACK, BLUE, CYAN,
   * DARK_GRAY, GRAY, GREEN, LIGHT_GRAY, MAGENTA, ORANGE, PINK, RED, WHITE, and YELLOW.
   *
  ...
  public static void polygon(double[] x, double[] y) {
    ...
    for (int i = 0; i < N; i++) path.lineTo((float) x[i], (float) y[i]);
    path.closePath();
    offscreen.draw(path);
    // draw();
  }
