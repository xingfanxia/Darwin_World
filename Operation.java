...
public enum Operation {
  ...
  public static Operation findOpFromString(String testString) {
    for (Operation op : Operation.values()) {
      if (op.name().equals(testString)) return op;
    }
    return null;
  }
  ...
  public static void main(String[] args) {
    ...
    else System.out.println("String " + opString + " does not match operation INFECT");

    if (op == Operation.IFENEMY)
      System.out.println("String " + opString + " matches operation IFENEMY");
    else System.out.println("String " + opString + " does not match operation IFENEMY");
  }
}
